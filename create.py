...
def getLink(video_path):
    ...
    cmd_transalte=f'ffmpeg -y -threads 6 -re -fflags +genpts -i "{video_path}" \
        ...
        -s:5 640x360 -ac 2 -vcodec libx264 -profile:v main -pix_fmt yuv420p -b:v:3 500k -maxrate:5 1000k -bufsize:5 1000k -r 30 -ar 44100 -g 48 -c:a aac -b:a:3 128k \
        -s:7 426x240 -ac 2 -vcodec libx264 -profile:v main -pix_fmt yuv420p -b:v:4 340k -maxrate:7 700k -bufsize:7 700k -r 30 -ar 44100 -g 48 -c:a aac -b:a:4 128k \
